...
export const RESET_PAGE_MY_QUOTES = 'RESET_PAGE_MY_QUOTES'
export const FETCH_MORE_MY_BOOKING = 'FETCH_MORE_MY_BOOKING'
export const RESET_PAGE_MY_BOOKING = 'RESET_PAGE_MY_BOOKING'
...
export function resetPageMyQuotes():Action {
    return {
        type: RESET_PAGE_MY_QUOTES
    }
}

export function getMoreMyBooking():Action {
    return {
        type: FETCH_MORE_MY_BOOKING
    }
}

export function resetPageMyBooking():Action {
    return {
        type: RESET_PAGE_MY_BOOKING
    }
}
